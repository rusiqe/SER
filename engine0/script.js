...
// http://javascript-source.com
//***********************************************
jQuery("#wowslider-container0").wowSlider({effect:"",prev:"",next:"",duration:63*100,delay:20*100,width:1024,height:768,autoPlay:false,autoPlayVideo:false,playPause:false,stopOnHover:false,loop:false,bullets:0,caption:true,captionEffect:"parallax",controls:true,controlsThumb:["data0/images/manu.jpg", "data0/images/reezi.jpg", "data0/images/shingi.jpg"],responsive:1,fullScreen:true,gestures:2,onBeforeStep:0,images:[{src:"./manu.jpg",title:"Emmanuel Maduwuro",descr:"Technical Director\n"},{src:"./reezi.jpg",title:"Resistente Mcobo ",descr:"Managing Director/Administrator.",href:"http://wowslider.net"},{src:"./shingi.jpg",title:"Shingai Muzondo",descr:"Marketing Director"}]});